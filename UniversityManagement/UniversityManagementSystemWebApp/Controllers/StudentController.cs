...
namespace UniversityManagementSystemWebApp.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,StudentEmail,StudentContactNo,RegistrationDate,Address,DepartmentId")]Student student)
        {
        ...
        //    department.DepartmentName = db.Departments.ToList().Find(x => x.DepartmentId == student.DepartmentId).DepartmentName;
        //    return Json(department.DepartmentName, JsonRequestBehavior.AllowGet);
        //}
    }
}
